            ...
            <form action="InsertServlet" method="POST">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" id="startStation" name="sstation" required>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control" id="endStation" name="estation" required>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="seats" name="seats" min="1" max="5" placeholder="Enter number of seats" required>
                </div>
